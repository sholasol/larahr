...
<div class="card shadow-none pd-20 mx-auto wd-300 text-center bd-1 align-self-center mt-5">
    ...
    <form action="{{ url('register_user') }}" method="post">
        ...
        <div class=" form-group input-group">
            ...
            <input class="form-control form-control-sm" value="{{ old('firstname') }}" name="firstname"
        ...
        <div class=" form-group input-group">
            ...
            <input class="form-control form-control-sm" value="{{ old('lastname') }}" name="lastname"
        ...
        <div class="form-group input-group">
            ...
            <input class="form-control form-control-sm" value="{{ old('email') }}" name="email"
        ...
        <div class="form-group input-group">
            ...
            <input class="form-control form-control-sm" value="{{ old('phone') }}" name="phone"
        ...
        <div class="form-group input-group">
            ...
            <input class="form-control form-control-sm" name="confirm_password" placeholder="Repeat password"
                type="password">
        </div>
