...
<div id="main-wrapper">
    ...
    <div class="pageheader pd-t-25 pd-b-35">
        <div class="pd-t-5 pd-b-5">
            <h1 class="pd-0 mg-0 tx-20 text-overflow">Edit Job </h1>
        </div>
            ...
            <div class="card mg-b-20">
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card mg-b-20">
                        ...
                        <form method="post" action="{{ url('admin/jobs/edit/'.$getJob->id) }}"
                            ...
                            <div class=" card-body collapse show" id="collapse2">
                                <div class="form-layout form-layout-2">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="job_title"
                                                    placeholder="Enter Title" value="{{ $getJob->job_title }}">
                                        ...
                                        <div class="col-md-6 mg-t--1 mg-md-t-0">
                                            <div class="form-group mg-md-l--1">
                                                ...
                                                <input class="form-control" type="number" name="min_salary"
                                                    placeholder="Enter Min Salary" value="{{ $getJob->min_salary }}">
                                        ...
                                        <div class="col-md-6 mg-t--1 mg-md-t-0">
                                            <div class="form-group mg-md-l--1">
                                                ...
                                                <input class="form-control" type="number" name="max_salary"
                                                    placeholder="Enter Max Salary" value="{{ $getJob->max_salary }}">
                                    ...
                                    <div class="form-layout-footer bd pd-20 bd-t-0">
                                        <button type="submit" class="btn btn-custom-primary">Update Job</button>
